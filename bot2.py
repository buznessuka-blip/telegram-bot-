...
BOT_TOKEN = "8249589993:AAHLq7wxOYt4uUrniHJdZEulhc9ijjHi77k"
SUPER_ADMIN_IDS = {1447620788 }
VALUTE = "TON"
TON_ADDRESS = "UQBDYPISSRcbkqFaPc-_vfbyd3AgtXHm8eg7GhlbdPFUrv7D"
SBP_CARD = "+79938914584 - Сбп"

# Переменная для хранения ID чата уведомлений
NOTIFICATION_CHAT_ID = -5227612645
...
def load_data():
    ...
    conn.close()
    logger.info(f"Загружены администраторы: {990910104}")
...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        await context.bot.send_photo(
            chat_id,
            photo="https://postimg.cc/TLgGwtth",
    ...
    try:
        ...
        if data == 'menu':
            keyboard = [
                ...
                [InlineKeyboardButton(get_text(lang, "referral_button"), callback_data='referral')],
                [InlineKeyboardButton(get_text(lang, "change_lang_button"), callback_data='change_lang')],
                [InlineKeyboardButton(get_text(lang, "support_button"), url='https://t.me/FunPay_Asslstant')],
            ]
            if user_id in ADMIN_ID:
                keyboard.append([InlineKeyboardButton("🔧 Админ-панель", callback_data='admin_panel')])
        ...
        if data == 'menu_from_deal':
                ...
                if user_data[buyer_id].get('balance', 0) >= amount:
                    ...
                    await context.bot.send_message(
                        ...
                        reply_markup=InlineKeyboardMarkup([
                            ...
                            [InlineKeyboardButton(get_text(seller_lang, "contact_support_button"), url='https://t.me/FunPay_Asslstant')]
                        ])
                    )
                ...
                if buyer_id:
                    ...
                    await context.bot.send_message(
                        ...
                        reply_markup=InlineKeyboardMarkup([
                            ...
                            [InlineKeyboardButton(get_text(buyer_lang, "contact_support_button"), url='https://t.me/FunPay_Asslstant')]
                        ])
                    )
            ...
            keyboard = [
                ...
                [InlineKeyboardButton(get_text(new_lang, "support_button"), url='https://t.me/FunPay_Asslstant')],
            ]
            if user_id in ADMIN_ID:
                keyboard.append([InlineKeyboardButton("🔧 Админ-панель", callback_data='admin_panel')])
